...
def process_matrix_file(input_filename, timeout_sec=60, ask_every_level=True):
...
"""
    ...
    if interrupted:
        summary += f";;; Calcolo INTERROTTO al livello {interrupted_level} (cardinalità delle ipotesi: {interrupted_level})\n"
    else:
...
timeout_sec = 60  # Durata massima in secondi 
